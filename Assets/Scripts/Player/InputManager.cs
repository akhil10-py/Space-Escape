...
public class InputManager : MonoBehaviour
{
    ...
    public void GetTeleportInput(InputAction.CallbackContext callbackContext)
    {
        teleportButton = callbackContext.ReadValue<float>();
    }
}